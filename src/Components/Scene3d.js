  ...
  loadModels = () => {
    ...
    loadBikeModel.onSuccess = t => {
      ...
      this.scene.getMeshByID("Ghidon").material = this.scene
        .getMeshByID("Ghidon")
        .material.clone();
      this.scene.getMeshByID("BidonRosu").material = this.scene
        .getMeshByID("BidonRosu")
        .material.clone();
      ...
      this.scene.getMeshByID("Ghidon").material.diffuseColor = this.colors[
        "grey"
      ];
      this.scene.getMeshByID("BidonRosu").material.diffuseColor = this.colors[
        "grey"
      ];
      this.scene.getMeshByID("Furca").material.diffuseColor = this.colors[
        "black"
      ];
      this.scene.getMeshByID("Cadru1").material.diffuseColor = this.colors[
        "white"
      ];
